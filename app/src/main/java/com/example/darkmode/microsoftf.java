...
public class microsoftf extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_microsoftf);
    ...
    private void microsoftForm()
    {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Constants.URL_MICROFORM, new Response.Listener<String>() {
            @Override
