...
public class NotAdapter extends ArrayAdapter<Event> {
    public ArrayList<Event> MainList;

    public ArrayList<Event> SubjectListTemp;

    public NotAdapter.SubjectDataFilter subjectDataFilter;

    public NotAdapter(Context context, int id, ArrayList<Event> subjectArrayList) {
    ...
    public Filter getFilter() {
        ...
        if (subjectDataFilter == null) {
            ...
            subjectDataFilter = new NotAdapter.SubjectDataFilter();
        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = vi.inflate(R.layout.not_layout, null);
