...
public class guest extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editDomain=(Spinner)findViewById(R.id.domain);
    ...
    private void opForm()
    {
        ...
        final String Domain=editDomain.getSelectedItem().toString();
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Constants.URL_GUESTFORM, new Response.Listener<String>() {
            @Override
