...
public class recruit extends AppCompatActivity implements View.OnClickListener {
    ...
    private void opForm()
    {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Constants.URL_RECRUITFORM, new Response.Listener<String>() {
            @Override
        ...
        com.example.darkmode.RequestHandler.getInstance(this).addToRequestQueue(stringRequest);
